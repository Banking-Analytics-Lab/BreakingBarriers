...
networkscores=pd.read_csv('~/projects/def-cbravo/jetzhou/SocialNetworkData/Data/multi_indexed_df_reverse_non_10_years_lagged_byhand_person_male.csv',index_col=False)
...
if job_id == 0: # all with all scores
    ...
    file_path_all = f'/home/jetzhou/projects/def-cbravo/jetzhou/SocialNetworkData/new_person_pagerank/male_results_match/results_match_nearest_{suffix}_all.pkl'
...
## move into channels with all
    ...
    suffix = 'all'
    file_path_all = f'/home/jetzhou/projects/def-cbravo/jetzhou/SocialNetworkData/new_person_pagerank/male_results_match/results_match_nearest_{suffix}_channels_{channel_single[0]}.pkl'
    with open(file_path_all, 'wb') as file:
        pickle.dump(results, file)
elif job_id == 2:
    data_source = networkscores_match
...
## move into measurements
    ...
    suffix = 'all'
    file_path_all = f'/home/jetzhou/projects/def-cbravo/jetzhou/SocialNetworkData/new_person_pagerank/male_results_match/results_match_nearest_{suffix}_measurements_{measurements_single[0]}.pkl'
    with open(file_path_all, 'wb') as file:
        pickle.dump(results, file)
elif job_id == 7:
    data_source = networkscores_match
